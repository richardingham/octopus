...
class ImmutableTestCase (unittest.TestCase):
	def setUp (self):
		self.p_int = machine.Property("Test immutable int property", type=int, options=None, min=None, max=None, unit=None, setter=None)
...
class MutableTestCase (unittest.TestCase):
	def setUp (self):
		...
		self.p_int = machine.Property("Test int property", type=int, options=None, min=None, max=None, unit=None, setter=_setter("p_int"))
		self.p_float = machine.Property("Test float property", type=float, options=None, min=None, max=None, unit=None, setter=_setter("p_float"))
		self.p_str = machine.Property("Test str property", type=str, options=None, min=None, max=None, unit=None, setter=_setter("p_str"))
	...
	def test_str_values (self):
		...
		for i in range(100):
			value = ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase) for _ in range(10))
...
class MaxMinTestCase (unittest.TestCase):
	def setUp (self):
		...
		self.p_max = machine.Property("Test max int property", type=int, options=None, min=None, max=100, unit=None, setter=_setter("p_max"))
		self.p_min = machine.Property("Test min int property", type=int, options=None, min=0, max=None, unit=None, setter=_setter("p_min"))
		self.p_maxmin = machine.Property("Test max/min int property", type=int, options=None, min=-100, max=100, unit=None, setter=_setter("p_maxmin"))
	...
	def test_maxmin (self):
		for i in range(100):
			...
			if value > 100:
				...
				if value < -100:
					self.assertFailure(self.p_maxmin.set(value), data.errors.ValueTooSmall)
				else:
...
class OptionsTestCase (unittest.TestCase):
	def setUp (self):
		...
		self.p_int = machine.Property("Test int property", type=int, options=(1, 2, 3, 4, 5), min=None, max=None, unit=None, setter=_setter("p_int"))
		self.p_str = machine.Property("Test str property", type=str, options=("apple", "banana", "cherry"), min=None, max=None, unit=None, setter=_setter("p_str"))
