...
class HCube(Machine):
    ...
    def setup(self):
        ...
        self.system_pressure_target = Property(
            title="Set System Pressure",
            type=int,
            unit="",
            min=0,
            max=100,
            setter=set_system_pressure,
        )
        ...
        self.column_temperature_target = Property(
            title="Set Column Temperature",
            type=int,
            unit="",
            min=0,
            max=100,
            setter=set_column_temperature,
        )
        ...
        self.hydrogen_mode = Property(
            title="Hydrogen Mode",
            type=str,
            options=("controlled", "full", "off"),
            setter=set_hydrogen_mode,
        )
        ...
        def interpret_to_list(sensor, values):
            def interpret(result):
                try:
                    ...
                    raise Exception(
                        "Unknown response to %s parameter: %s" % (sensor.title, result)
                    )
    ...
    def shutdown(self):
        ...
        self.protocol.write("BC=06").addCallbacks(stop, d.errback)
